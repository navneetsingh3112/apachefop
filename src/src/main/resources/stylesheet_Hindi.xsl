...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
        ...
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
            ...
            <fo:page-sequence master-reference="simple">
                <fo:flow flow-name="xsl-region-body">
                    ...
                    <!--Header of the pdf-->
                    <fo:block text-align="center" font-family="Mangal" font-size="8pt" font-weight="bold" margin-bottom="1cm" margin-top="-0.8cm">
                        ...
                        <fo:table-body>
                            <fo:table-row height="14pt" margin-left="2pt" >
                                <fo:table-cell padding="1pt" number-columns-spanned="2">
                                    <fo:block font-family="Mangal" font-size="8pt">
                            ...
                            <fo:table-row height="14pt" margin-left="2pt">
                                ...
                                <fo:table-cell padding="1pt">
                                    <fo:block font-family="Mangal" font-size="8pt" margin-left="8pt">
                                        सीआईएन:
                                    </fo:block>
                                </fo:table-cell>
                                <fo:table-cell padding="1pt">
                                ...
                                <fo:table-cell padding="1pt">
                                    <fo:block font-family="Mangal" font-size="8pt" margin-left="20pt">
                                        पैन:
                                    </fo:block>
                                </fo:table-cell>
                                <fo:table-cell padding="1pt">
                            ...
                            <xsl:for-each select="LoanCardFactSheet/CustomerDetails">
                                ...
                                <fo:table-row height="11pt">
                                    <fo:table-cell padding="4pt" border="1pt solid black">
                                        <fo:block font-size="8pt" font-family="Mangal">
                                            <fo:inline>
                                                <!-- Concatenate Customer Name and Customer ID -->
                                                ग्राहक का नाम &amp; पहचान: <xsl:value-of select="CustomerName"/> &amp; <xsl:value-of select="CustomerID"/>
                                            </fo:inline>
                                                ...
                                                <xsl:for-each select="*[self::LoanAccount or self::GroupName or self::Product or self::HusbandName or self::CustomerAddress or self::DisbursedDate or self::LoanAmount or self::TotalInterestCharge or self::OtherUpfrontCharges or self::ProcessingFees or self::InsuranceAmount or self::OtherCharges or self::NetDisbursedAmount or self::TotalAmountToBePaid or self::AnnualizedInterestRate or self::RateOfInterest]">
                                                    <xsl:choose>
                                                        ...
                                                        <xsl:when test="name() = 'ProcessingFees'">
                                                            <fo:block>
                                                                प्रक्रमण फीस: <xsl:value-of select="."/>
                                                            </fo:block>
                                                        </xsl:when>
                                                        <xsl:when test="name() = 'InsuranceAmount'">
                                                            <fo:block>
                                                                बीमा राशि: <xsl:value-of select="."/>
                                                            </fo:block>
                                                        </xsl:when>
                                                        <xsl:when test="name() = 'OtherCharges'">
                                                            <fo:block>
                                                                अन्य शुल्क: <xsl:value-of select="."/>
                                                            </fo:block>
                                                        </xsl:when>
                                                        ...
                                                        <xsl:when test="name() = 'TotalAmountToBePaid'">
                                                            <fo:block>
                                                                भुगतान की जाने वाली कुल राशि: <xsl:value-of select="."/>
                                                            </fo:block>
                                                        </xsl:when>
                                                        ...
                                                        <xsl:when test="name() = 'RateOfInterest'">
                                                            <fo:block>
                                                                ब्याज की दर: <xsl:value-of select="."/>
                                                            </fo:block>
                                                        </xsl:when>
                                                ...
                                                <xsl:for-each select="*[self::MobileNo or self::FatherName or self::CoApplicantName or self::CentrePlace or self::LoanTerm or self::RepaymentFrequency or self::NumberOfInstallments or self::RepaymentDate or self::RepaymentAmount or self::LendingType or self::LoanCycle or self::BankAccountNo or self::Purpose or self::BeneficiaryAccountName or self::BankName or self::NetoffAccountAmount]">
                                                    <xsl:choose>
                                                        ...
                                                        <xsl:when test="name() = 'MobileNo'">
                                                            <fo:block>
                                                                मोबाइल नंबर: <xsl:value-of select="."/>
                                                            </fo:block>
                                                        </xsl:when>
                    ...
                    <!-- Installment details-->
                    <fo:table width="100%" border="1pt solid black" font-family="Mangal">
                        <fo:table-header>
                            <fo:table-row>
                                <fo:table-cell border="1pt solid black" padding="2pt">
                                    <fo:block font-size="8" text-align="center">किस्त संख्या</fo:block>
                                </fo:table-cell>
                                <fo:table-cell border="1pt solid black" padding="2pt">
                                    <fo:block font-size="8" text-align="center">चुकौती तिथि</fo:block>
                                </fo:table-cell>
                                <fo:table-cell border="1pt solid black" padding="2pt">
                                    <fo:block font-size="8" text-align="center">बेहतरीन सिद्धांत</fo:block>
                                </fo:table-cell>
                                <fo:table-cell border="1pt solid black" padding="2pt">
                                    <fo:block font-size="8" text-align="center">मूल धन</fo:block>
                                </fo:table-cell>
                                <fo:table-cell border="1pt solid black" padding="2pt">
                                    <fo:block font-size="8" text-align="center">ब्याज</fo:block>
                                </fo:table-cell>
                                <fo:table-cell border="1pt solid black" padding="2pt">
                                    <fo:block font-size="8" text-align="center">किस्त की राशि</fo:block>
                                </fo:table-cell>
                                <fo:table-cell border="1pt solid black" padding="2pt">
                                    <fo:block font-size="8" text-align="center">भुगतान की स्थिति</fo:block>
                                </fo:table-cell>
                                <fo:table-cell border="1pt solid black" padding="2pt">
                                    <fo:block font-size="8" text-align="center">एकत्रित की गई राशि</fo:block>
                                </fo:table-cell>
                                <fo:table-cell border="1pt solid black" padding="2pt">
                                    <fo:block font-size="8" text-align="center">एकत्रित राशि</fo:block>
                                </fo:table-cell>
                                <fo:table-cell border="1pt solid black" padding="2pt">
                                    <fo:block font-size="8" text-align="center">कर्मचारी कोड</fo:block>
                                </fo:table-cell>
                                <fo:table-cell border="1pt solid black" padding="2pt">
                                    <fo:block font-size="8" text-align="center">कर्मचारी हस्ताक्षर</fo:block>
                                </fo:table-cell>
                            </fo:table-row>
                        </fo:table-header>
                        <fo:table-body>
                            ...
                            <xsl:for-each select="LoanCardFactSheet/Installments/*">
                                <fo:table-row>
                                    ...
                                    <fo:table-cell border="1pt solid black" padding="15pt" number-columns-spanned="2">
                                        <fo:block text-align="center" font-size="8pt">कुल</fo:block>
                                    </fo:table-cell>
                        ...
                        <fo:table-header>
                            <fo:table-row border="1pt solid black">
                                <fo:table-cell border="1pt solid black">
                                    <fo:block font-family="Mangal" font-size="8pt" font-weight="bold" text-align="center">
                                        प्रोसेसिंग शुल्क &amp; स्टांप शुल्क शुल्क
                                    </fo:block>
                                </fo:table-cell>
                                <fo:table-cell border="1pt solid black">
                                    <fo:block font-family="Mangal" font-size="8pt" font-weight="bold" text-align="center">
                    ...
                    <fo:block font-family="Mangal" font-size="8pt" font-weight="bold" margin-top="0.5cm" margin-bottom="0.2cm">
                    ...
                    <fo:block font-size="8pt" font-family="Mangal">
                        <xsl:text> किसी भी प्रश्न के लिए, कृपया हमारे नोडल अधिकारी से संपर्क करें</xsl:text>
                    </fo:block>
                    <fo:table width="100%" border="1pt solid black">
                        <fo:table-header>
                            <fo:table-row>
                                <fo:table-cell border="1pt solid black">
                                    <fo:block text-align="center" font-size="8pt" font-family="Mangal">नोडल अधिकारी का नाम</fo:block>
                                </fo:table-cell>
                                <fo:table-cell border="1pt solid black">
                                    <fo:block text-align="center" font-size="8pt" font-family="Mangal">
                                        नोडल अधिकारी संपर्क नंबर</fo:block>
                                </fo:table-cell>
                            </fo:table-row>
                        </fo:table-header>
                        <fo:table-body>
                            <fo:table-row height="10mm">
                                <fo:table-cell border="1pt solid black">
                                    <fo:block font-family="Mangal"  font-size="8pt" text-align="center"><xsl:value-of select="LoanCardFactSheet/GrievanceRedressal/NodalOfficerName"/></fo:block>
                                </fo:table-cell>
                                <fo:table-cell border="1pt solid black">
                                    <fo:block font-family="Mangal" font-size="8pt" text-align="center"><xsl:value-of select="LoanCardFactSheet/GrievanceRedressal/NodalOfficerContactNo"/></fo:block>
                                </fo:table-cell>
                            </fo:table-row>
                        </fo:table-body>
                    </fo:table>
    ...
    <xsl:template match="ProcessingFeeAndStampDuty/*">
        <fo:block font-size="8pt" padding="4pt" font-family="Mangal">
            <xsl:choose>
