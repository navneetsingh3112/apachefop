...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            File fontFile = new File("/home/soumenmanna/Desktop/apachefop-hindi/src/src/main/resources/fonts/MANGAL.TTF");
            ...
            StreamSource src = new StreamSource(new File("src/src/main/resources/input_Hindi.xml"));
